...
def test_com_box():
    ...
    box = ase.Atoms()
    # add 5 ethanol molecules, shift them each so they don't overlap and then ensure the COM from rdkit2ase.get_center_of_mass(ethanol) matched the COM of each individual ethanol
